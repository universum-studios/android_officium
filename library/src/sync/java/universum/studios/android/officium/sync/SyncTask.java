 ...
 * <p>
 * Creation of instances of {@link SyncTask SyncTasks} is restricted via {@link SyncTask.Builder} only.
 * <p>
 * If synchronization related to a particular SyncTask depends on some additional data that are needed
 * to perform synchronization logic, these data can be specified via {@link SyncTask.Builder#request(Request)}.
 ...
 * via custom implementation of {@link SyncTask.Builder} or from/into extras {@link Bundle}.
 *
...
public class SyncTask<R extends SyncTask.Request> implements Cloneable {
	 ...
	 * @author Martin Albedinsky
	 */
	public static class Builder<R extends SyncTask.Request> {
